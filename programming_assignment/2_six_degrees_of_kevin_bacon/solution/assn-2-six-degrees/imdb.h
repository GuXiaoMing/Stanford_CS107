...
class imdb {
 ...
 private:
  ...
  static int PlayerCmpFn(const void *key, const void *offset);
  static int FilmCmpFn(const void *key, const void *offset);
  static string GetPlayer(const void *file, int start_offset, int &end_offset);
  static film GetFilm(const void *file, int start_offset, int &end_offset);
  static void GetValues(const void *file, int offset, int *&base, short &length);
};
